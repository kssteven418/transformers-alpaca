...
class RWModel(RWPreTrainedModel):
    ...
    def split(self, jumps=1):
        self.word_embeddings.to(f"cuda:0")
        self.ln_f.to(f"cuda:0")
        self.jump_indices = []
        prev_device = 0
        nums = len(self.h) // (jumps + 1)
    ...
    def forward(
        ...
        **deprecated_arguments,
        ...
        for i, (block, layer_past) in enumerate(zip(self.h, past_key_values)):
            ...
            if self.do_jump and i in self.jump_indices:
                print("Jump!", i)
                device += 1
            ...
            if self.do_jump and i == len(self.h) - 1:
                print("hell back!", i)
